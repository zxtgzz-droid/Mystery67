...
local AutoSummonToggle = SummonTab:Toggle({
    Title = "Auto Summon", Desc = "Automatically summon units", Value = false,
...
FarmTab:Paragraph({Title = "Set 4 (Toilet HQ) 👑", Desc = "⭐ Premium Script Only"})
                ...
                if lastLocation ~= "InGame" then
                    ...
                    elseif State.Select_UnitSet == "Set 4 (Toilet HQ)" then
                        WindUI:Notify({
                            ...
                            Content = "Set 4 สำหรับ Premium เท่านั้น",
                            Icon = "crown",
                            Duration = 5
                        })
